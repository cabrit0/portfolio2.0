...
const About = () => {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-myGreen-800 p-8">
      <h1 className="text-4xl md:text-5xl font-medium text-white mb-4">
        About
      </h1>
      <p className="text-lg md:text-xl text-myBege-800 opacity-80 mb-8">
      ...
      <div className="w-4/5">
        ...
        <p className="text-lg md:text-xl text-myBege-800 opacity-80 mb-4">
